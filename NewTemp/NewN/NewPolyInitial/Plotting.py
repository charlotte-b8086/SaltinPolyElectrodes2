...
#    
#    dfcp  = pd.read_csv(f"Charge_out_cp_sample_0250.csv")
#    dfcn  = pd.read_csv(f"Charge_out_cn_sample_0250.csv")
#    dfcm  = pd.read_csv(f"Charge_out_cm_sample_0250.csv")
#
...
#    
#    dfci  = pd.read_csv(f"Charge_out_ci_sample_0250.csv")
#    dfce  = pd.read_csv(f"Charge_out_rho_sample_0250.csv")
#    ciMskL = dfci['x']<=0
#    ciMskR = dfci['x']>=1
#    dfciL = dfci[ciMskL]
#    dfciR = dfci[ciMskR]
...
#    
#    dfpsiM = pd.read_csv(f"Charge_out_psi_sample_0250.csv")
#    dfpsiE = pd.read_csv(f"Charge_out_psi_e_sample_0250.csv")
#    psiLMsk = dfpsiE['x']<=0
#    psiRMsk = dfpsiE['x']>=1
...
#
    ...
    axesV.plot(t_v, v, color='k', marker='o', markersize=2, label="Charge")
    axesV.plot(max(t_v)+t_vD, vD, color="tab:blue", marker='o', markersize=2, label="Discharge")
    ...
    axesV.legend()
    figV.tight_layout()
    figV.savefig("V(t)Again", dpi=150)
    figU, axesU = plt.subplots(figsize=(16, 4.5))
    axesU.plot(t_v, iR, color='k', marker='o', markersize=2, label="Charge")
    axesU.plot(max(t_v)+t_vD, iRD, color="tab:blue", marker='o', markersize=2, label="Discharge")
    ...
    axesU.legend()
    figU.tight_layout()
    figU.savefig("U(t)Again", dpi=150)
