...
#  [activate_I]
#    type = TimePeriod
#    enable_objects = 'BCs/e_neumann_left BCs/e_neumann_right'
#    start_time = 1
#  []
#[]
...
[Materials]  
  [cation_diff]
    ...
    #expression        = '${D_p}*(1+cp/(((1-cp-cn-cm))))'
  ...
  [anion_diff]
    type              = ADParsedMaterial
    coupled_variables = 'cp cn cm'
    #expression        = '${D_n}*(1+cn/(((1-cp-cn-cm))))'
  ...
  [poly_diff]
    type              = ADParsedMaterial
    coupled_variables = 'cp cn cm'
    #expression        = '${D_m}*(1/${N}+${rho_M}*cm/(((1-cp-cn-cm))))'
  ...
  [poly_crossdiff]
    type              = ADParsedMaterial
    coupled_variables = 'cp cn cm'
    #expression        = '${D_m}*${rho_M}*cm/((1-cp-cn-cm))'
