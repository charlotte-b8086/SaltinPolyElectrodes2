...
def main():
  tau = 34.855901850999416
  rhoM =  0.00011836005309709462 
  ...
  suffixes = ["0000", "0050", "0100", "0150", "0200", "0250", "0300", "0350", "0400", "0450"]
    # Expanded colorblind-friendly palette (10 distinct colors)
  colors = [
      "#000000",  # Black
      "#56B4E9",  # Sky Blue
      "#0072B2",  # Blue
      ...
      "#781C68",  # Deep Plum / Wine (Added for 10th spot)
      "#999999"   # Gray
  ]
  for i, s in enumerate(suffixes):
      ...
      axesCharge.plot( dfcp['x'], rhoP*(dfcp['cp']-dfcn['cn']), '.', color=colors[i])
  ...
  axesCharge.set_ylabel(r"""Number Density of Charge (1/m$^3$) 
                     ...
                     $\ \rho_+(x,t)-\rho_-(x,t) \text{ for } 0 < x < 1,$
