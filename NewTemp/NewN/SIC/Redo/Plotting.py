...
### Troubleshooting
    ...
    axesV.plot(tau*(max(t_v)+t_vD), kB*temp*vD/eC, color="tab:blue", marker='o', markersize=2, label="Discharge")
    ...
    axesU.plot(tau*(max(t_v)+t_vD), iRD, color="tab:blue", marker='o', markersize=2, label="Discharge")
